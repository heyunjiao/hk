  ...
  <div class="member-list">
    <div class="page-title">
      <PageTitle :title="$t('route.orderManage')">
        <template v-if="!this.$route.query.name" slot="btn">
          <el-button
            size="large"
            type="primary"
            @click="openOrderFn"
    ...
    <div class="table-list">
      <div>
        ...
        <Table
          ...
          :handle-selection-change-com="handleSelectionChangeCom"
    ...
    >
      <el-form ref="form" :model="sizeForm" label-width="166px" label-position="right">
        ...
        <el-form-item v-if="sizeForm.resource==='1'" :label="$t('useCommonAll.ticketAmount')">
          <span style="margin-right:6px">$</span><el-input-number :controls="false" />
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    confirmFn() {
      ...
      this.$t('useCommonAll.operatorSuciscess')
    },
    pushToDetail(v, row) {
      this.$router.push({
        path: '/orderManage/AddOrder',
