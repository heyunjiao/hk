  ...
  <div class="demo">
    ...
    <div>
      ...
      >
        ...
        <template slot="localDropDownBox" scope="{row}">
          <!--下拉框控件插槽-->
          <el-select
            v-model="row.localDropDownBox"
            clearable
            placeholder="请选择"
          >
            <el-option
        ...
        <template slot="singleLineTextBox" scope="{row}">
          <!--输入框控件插槽-->
          <el-input
            placeholder="请输入内容"
        ...
        <template slot="type" scope="{row}"
          ...
          <p
            ...
            :style="
              row.type
                ? 'color: #5E9CFF;border-color: #5E9CFF;'
                : 'color: #EC8674;border-color: #EC8674;'
            "
          >
            {{ row.type ? $t("demo.page.approve") : $t("demo.page.Refuse") }}
          </p>
        </template>
      </Tabel>
    </div>
        ...
        formData: [
          {
            ...
            category: 0,
            customParameters:
              "TextBox" /*自定义参数 可设置为提交接口参数的key 提交事件之后根据自定义参数返回 */,
            classname: "",
            classnameitem: "",
          },
          {
          ...
          },
          {
            ...
            options: [
              /*筛选 数据源*/ { value: 1, label: "Option 1", disabled: false },
              {
                value: 2 /*选中参数*/,
                label: "Option 2" /*选中标题*/,
...
<style lang="scss">
.borderBlue {
  border-left: 5px solid #06a7ff !important;
  border-radius: 0;
}
.borderOrange {
